...
main ()
{
  ...
  employees.push_back (HR::Employee{ .firstName      = "John",
                                     .lastName       = "White",
                                     .employeeNumber = 42,
                                     .salary = 80'000, .title = HR::Title::SeniorEngineer });

  employees.push_back (HR::Employee{
      .firstName = "John", .lastName = "Doe", .employeeNumber = 133, .salary = 64'000, .title = HR::Title::Engineer });

  employees.push_back (HR::Employee{
        .firstName = "Jane", .lastName = "Doe", .employeeNumber = 18,
