...
Person::Impl::Impl (string firstName, string lastName) : m_firstName{ move (firstName) }, m_lastName{ move (lastName) }
{
...
const string &
Person::Impl::getFirstName () const
{
  return m_firstName;
}
void
Person::Impl::setFirstName (string firstName)
{
  m_firstName = move (firstName);
}

const string &
Person::Impl::getLastName () const
{
  return m_lastName;
}
void
Person::Impl::setLastName (string lastName)
{
  m_lastName = move (lastName);
}

const string &
Person::Impl::getInitials () const
{
  return m_initials;
}
void
Person::Impl::setInitials (string initials)
{
...
Person::Person (string firstName, string lastName) : m_impl{ make_unique<Impl> (move (firstName), move (lastName)) } {}
...
const string &
Person::getInitials () const
{
  return m_impl->getInitials ();
}
void
Person::setInitials (string initials)
{
