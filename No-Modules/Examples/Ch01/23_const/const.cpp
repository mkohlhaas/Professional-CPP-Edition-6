...
void constIntPtrOne() { int const *const ip [[maybe_unused]]{nullptr}; }

void constIntPtrTwo() { const int *const ip [[maybe_unused]]{nullptr}; }
// the same (more idiomatic):
void constIntPtrThr() { int const *const ip [[maybe_unused]]{nullptr}; }
