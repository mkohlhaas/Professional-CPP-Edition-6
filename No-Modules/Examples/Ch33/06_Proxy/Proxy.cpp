...
string
Player::sendInstantMessage (string_view message) const
{
  // ...
  return "yes";
}
...
string
PlayerProxy::getName () const
{
  return m_player->getName ();
}

string
PlayerProxy::sendInstantMessage (string_view message) const
{
...
bool
PlayerProxy::hasNetworkConnectivity () const
{
...
bool
informWinner (const IPlayer &player)
{
