...
template <typename DirectedGraph> class const_adjacent_nodes_iterator_impl
{
  public:
...
const_adjacent_nodes_iterator_impl<DirectedGraph>::const_adjacent_nodes_iterator_impl(iterator_type        it,
...
template <typename DirectedGraph>
typename const_adjacent_nodes_iterator_impl<DirectedGraph>::reference const_adjacent_nodes_iterator_impl<
    DirectedGraph>::operator*() const
{
...
template <typename DirectedGraph>
typename const_adjacent_nodes_iterator_impl<DirectedGraph>::pointer const_adjacent_nodes_iterator_impl<
    DirectedGraph>::operator->() const
{
    return &((*m_graph)[*m_adjacentNodeIterator]);
}
...
template <typename DirectedGraph>
const_adjacent_nodes_iterator_impl<DirectedGraph> &const_adjacent_nodes_iterator_impl<DirectedGraph>::operator++()
{
...
template <typename DirectedGraph>
const_adjacent_nodes_iterator_impl<DirectedGraph> const_adjacent_nodes_iterator_impl<DirectedGraph>::operator++(int)
{
    auto oldIt{*this};
    ++*this;
    return oldIt;
