...
template <typename T> class Grid
{
  public:
    ...
    template <typename Self> auto &&at(this Self &&self, std::size_t x, std::size_t y);
...
// }
template <typename T> template <typename Self> auto &&Grid<T>::at(this Self &&self, std::size_t x, std::size_t y)
{
