...
void
PhoneBook::addPhoneNumber (const Person &person, string_view phoneNumber)
{
  m_phoneBook.emplace (person, phoneNumber);
}

void
PhoneBook::removePhoneNumber (const Person &person, string_view phoneNumber)
{
...
vector<string>
PhoneBook::getPhoneNumbers (const Person &person) const
{
  auto [begin, end]{ m_phoneBook.equal_range (person) };
