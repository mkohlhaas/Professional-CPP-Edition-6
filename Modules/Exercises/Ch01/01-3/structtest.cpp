...
main ()
{
  ...
  HR::Employee employee1{
    .firstInitial = 'J', .lastInitial = 'W', .employeeNumber = 42, .salary = 80'000, .title = HR::Title::SeniorEngineer
  };

  HR::Employee employee2{
    .firstInitial = 'J', .lastInitial = 'D', .employeeNumber = 133, .salary = 64'000, .title = HR::Title::Engineer
  };

  HR::Employee employee3{
    .firstInitial = 'B', .lastInitial = 'P', .employeeNumber = 18, .salary = 100'000, .title = HR::Title::Manager
  };
