...
bool
BankDB::addAccount (const BankAccount &account)
{
...
void
BankDB::deleteAccount (int accountNumber)
{
  m_accounts.erase (accountNumber);
}

BankAccount &
BankDB::findAccount (int accountNumber)
{
...
BankAccount &
BankDB::findAccount (string_view name)
{
...
void
BankDB::mergeDatabase (BankDB &db)
{
  // Use merge().
