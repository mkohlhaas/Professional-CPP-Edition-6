...
double
arithmeticMean (span<const int> values)
{
...
double
geometricMeanLambda (span<const int> values)
{
  int mult{ accumulate (cbegin (values), cend (values), 1, [] (int value1, int value2) { return value1 * value2; }) };
  return pow (mult, 1.0 / values.size ());
}

double
geometricMeanFunctor (span<const int> values)
{
