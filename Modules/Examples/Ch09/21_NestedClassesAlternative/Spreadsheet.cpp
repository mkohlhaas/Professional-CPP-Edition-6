...
Spreadsheet::Spreadsheet (const Spreadsheet &src) : Spreadsheet{ src.m_width, src.m_height, src.m_theApp }
{
...
void
Spreadsheet::setCellAt (size_t x, size_t y, const Cell &cell)
{
...
Spreadsheet::getCellAt (size_t x, size_t y) const
{
  verifyCoordinate (x, y);
  return m_cells[x][y];
}
...
Spreadsheet::Cell::Cell (string_view initialValue) : m_value{ stringToDouble (initialValue) } {}

void
Spreadsheet::Cell::set (double value)
{
  m_value = value;
}

double
Spreadsheet::Cell::getValue () const
{
  return m_value;
}

void
Spreadsheet::Cell::set (string_view value)
{
  m_value = stringToDouble (value);
}

string
Spreadsheet::Cell::getString () const
{
  return doubleToString (m_value);
}

string
Spreadsheet::Cell::doubleToString (double value) const
{
  return to_string (value);
}

double
Spreadsheet::Cell::stringToDouble (string_view value) const
{
  double number{ 0 };
