...
void
GameBoard::verifyCoordinate (size_t x, size_t y) const
{
  if (x >= m_width)
    {
...
void
GameBoard::swap (GameBoard &other) noexcept
{
...
void
swap (GameBoard &first, GameBoard &second) noexcept
{
  first.swap (second);
}
...
const unique_ptr<GamePiece> &
GameBoard::at (size_t x, size_t y) const
{
...
GameBoard::at (size_t x, size_t y)
{
