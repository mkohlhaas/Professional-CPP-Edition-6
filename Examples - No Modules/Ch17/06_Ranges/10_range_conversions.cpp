...
main ()
{
  ...
  auto vec2{ views::iota (10, 15) | views::transform ([] (const auto &v) { return v / 2.0; })
  ...
  auto   words{ lorem | views::split (' ') | views::transform ([] (const auto &v) { return string{ from_range, v }; })
              | ranges::to<vector> () };
