...
void
BuddyList::addBuddy (const string &name, const string &buddy)
{
...
void
BuddyList::removeBuddy (const string &name, const string &buddy)
{
...
bool
BuddyList::isBuddy (const string &name, const string &buddy) const
{
  // Obtain the beginning and end of the range of elements with
...
vector<string>
BuddyList::getBuddies (const string &name) const
{
  /*
  // Obtain the beginning and end of the range of elements with
  // key 'name' using equal_range(), and structured bindings.
