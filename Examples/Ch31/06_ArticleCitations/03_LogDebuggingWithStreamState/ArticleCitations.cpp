...
ArticleCitations::ArticleCitations (const ArticleCitations &src) { copy (src); }
...
void
ArticleCitations::copy (const ArticleCitations &src)
{
...
ArticleCitations::~ArticleCitations () { delete[] m_citations; }

void
printStreamState (const istream &inputStream)
{
  if (inputStream.good ())
    {
...
void
ArticleCitations::readFile (const string &filename)
{
...
const string &
ArticleCitations::getArticle () const
{
  return m_article;
}

int
ArticleCitations::getNumCitations () const
{
  return m_numCitations;
}

const string &
ArticleCitations::getCitation (int i) const
{
